...
bool** GOLOpenCL::runGenerations(bool** world, bool** newWorld, unsigned int width, unsigned int height, unsigned int generations)
{
	bool** temp;
...
int GOLOpenCL::getNeighborsAlive(bool** world, int x, int y, unsigned int width, unsigned int height)
{
